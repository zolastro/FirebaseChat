...
export class ContactsComponent implements OnInit{
  ...
  constructor(public db: AngularFireDatabase, public afAuth: AngularFireAuth,
    ...
    this.user.subscribe((user: firebase.User) => {
      ...
      if (user) { // User is signed in!
        ...
        // We load currently existing chat contacts.
        ...
        //     if (contacts.entities) {
        //       for (let entity of contacts.entities) {
        ...
        //   setTimeout(() => {
        //     const messageList = document.getElementById('contacts');
  ...
  saveMessage(event: any, el: HTMLInputElement) {
    ...
    if (this.value && this.checkSignedInWithMessage()) {
      ...
      const contacts = this.db.list('/contacts');
      contacts.push({
